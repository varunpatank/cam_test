            ...
            {papers.map((paper) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <Link
                      href={`https://dynamicpapers.com/wp-content/uploads/2015/09/${subjectCode}_${sessionCode}${yearCode}_qp_${paperCode}${variantCode}.pdf`}
                    ...
                    >
                      ...
                      {hasMsPaper && (
                        <div className="p-4 bg-purple-900 text-center">
                          <Link
                            href={`https://dynamicpapers.com/wp-content/uploads/2015/09/${subjectCode}_${sessionCode}${yearCode}_ms_${paperCode}${variantCode}.pdf`}
